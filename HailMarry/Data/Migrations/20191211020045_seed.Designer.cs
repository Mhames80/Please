            ...
            modelBuilder.Entity("BackupProject.Models.Discussion", b =>
                {
                    ...
                    b.HasData(
                        new { DiscussionId = 1, Comment = "WE WON!!!!!", ContactInfoId = 1, PostedAt = new DateTime(2019, 12, 10, 21, 0, 45, 144, DateTimeKind.Local) },
                        new { DiscussionId = 2, Comment = "WE LOST!!!!!", ContactInfoId = 2, PostedAt = new DateTime(2019, 12, 10, 21, 0, 45, 146, DateTimeKind.Local) }
                    );
                });
